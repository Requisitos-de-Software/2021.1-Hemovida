...
As user stories ou Historias de [usuário](./modelagem/lexico?id=usuário) são uma descrição de uma necessidade do [usuário](./modelagem/lexico?id=usuário) do produtor sobre o ponto de vista desse [usuário](./modelagem/lexico?id=usuário). Ela busca descrever requisitos de uma forma simples e leve.
...
| Épico | Feature | ID | História de [Usuário](./modelagem/lexico?id=usuário) | Requisito |
| ----- | ------- | -- | ------------------- | --------- |
